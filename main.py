...
def main():
    ...
    smtp_server = r'smtp.gmail.com'  # For Gmail
    port = 587  # For TLS
    sender_email = 'shahfaisal15401@gmail.com'  # Replace with your email
    password = '12345'  # Replace with your email password or app password
    receiver_email = 'shahfaisal15401@gmail.com'  # Replace with receiver's email
    subject = 'Robbery Alert'
    body = 'Please Find the attached footage of Robbery and Call Emergency.'


    # Load model
    model = load_yolo_model(r"robbery.pt")

    # Initialize video capture
    cap = initialize_video_capture(r"input_video\robbing.mp4")
